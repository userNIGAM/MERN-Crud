  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex items-center justify-center p-4">
      <div className="flex flex-col items-center w-full max-w-md">
        {/* Show User Data Button - moved here */}
        <Link to="/userdata">
          <button className="mb-6 w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg transition duration-200">
            Show User Data
          </button>
        </Link>

        <div className="bg-white dark:bg-gray-800 shadow-xl rounded-2xl p-8 w-full">
